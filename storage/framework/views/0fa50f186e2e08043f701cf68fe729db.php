...
<div class="row">
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100">
            ...
            <div class="card-body">
                <form id="addDoctorForm" action="<?php echo e(route('doctors.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\dental\resources\views/content/doctor/index.blade.php ENDPATH**/ ?>