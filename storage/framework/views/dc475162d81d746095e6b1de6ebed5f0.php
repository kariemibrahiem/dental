...
<div class="row">
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100">
            ...
            <div class="card-body">
                <form id="addPatientForm" action="<?php echo e(route('patients.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="patientDate" name="date" value="<?php echo e(date('Y-m-d')); ?>" required />
                    </div>
...
$(document).ready(function () {
    const table = $('#patientsTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route("patients.index")); ?>',
        columns: [
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projects\dental\resources\views/content/patient/index.blade.php ENDPATH**/ ?>